...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/lbryio/lbcutil/hdkeychain)
...
```bash
$ go get -u github.com/lbryio/lbcutil/hdkeychain
```
